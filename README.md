...
- **WEG — Integrated Manufacturing Systems:** hands-on delivery across internal applications, code review, CI/CD, and Kubernetes-based QAS deployment, with work spanning application integration, legacy compatibility, performance, and manufacturing-domain workflows.
